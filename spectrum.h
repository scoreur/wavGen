...
extern Complex* fourier0(short* data, int samplesize, double freq1,  short frsize = 1, short *freq = 0);//4倍周期取样，返回各泛音复振幅数组首地址
...
public:
    Complex spectrum[ NOTENUM ];//amplitude for each note
    ...
    void update(short * data, short samplesize);//以所给数据地址为中心采样，更新频谱
